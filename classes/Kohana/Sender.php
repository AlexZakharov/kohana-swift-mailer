...
class Kohana_Sender
{
     ...
     *     $email = self::instance('custom', $config);
     *
    ...
    public static function instance($name = NULL, array $config = NULL)
    {
        ...
        if (!isset(self::$instances[$name])) {
            if ($config === NULL) {
                ...
                $config = Kohana::$config->load('sender')
                    ->as_array();
            }
            ...
            self::$instances[$name] = new self($name, $config[$name]);
        }
     ...
     *
     * [!!] This method cannot be accessed directly, you must use [self::instance].
     *
     * @return  void
     */
    ...
    public function send()
    {
        ...
        return (bool)$this->_connection->send($message);
    }
